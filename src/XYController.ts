...
export class XYController {
  private readonly coords: Vec2 = { x: 0, y: 0 }
  private readonly value: Vec2 = { x: 0, y: 0 }
  private readonly buttonSize: Vec2 = { x: 0, y: 0 }

  private readonly canvas: HTMLCanvasElement
  private readonly onChangeCallback: (value: Vec2) => void
