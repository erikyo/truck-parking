...
export default class Player {
  ...
  private readonly turretPivot = new THREE.Object3D()
  private readonly turretMesh = new THREE.Mesh()
  ...
  private readonly bulletMesh = [new THREE.Mesh(), new THREE.Mesh(), new THREE.Mesh()]
  private lastBulletCounter = [-1, -1, -1] // used to decide if a bullet should instantly be repositioned or smoothly lerped

  partIds: number[] = []

  private readonly frameBody: CANNON.Body
  private readonly wheelLFBody: CANNON.Body
  private readonly wheelRFBody: CANNON.Body
  private readonly wheelLBBody: CANNON.Body
  private readonly wheelRBBody: CANNON.Body

  enabled = false
  private screenName = ''
  private lastScreenName = ''

  private readonly targetPosFrame = new THREE.Vector3()
  private readonly targetPosTurret = new THREE.Vector3()
  private readonly targetPosWheelLF = new THREE.Vector3()
  private readonly targetPosWheelRF = new THREE.Vector3()
  private readonly targetPosWheelLB = new THREE.Vector3()
  private readonly targetPosWheelRB = new THREE.Vector3()
  ...
  private readonly annotationDiv = document.createElement('div')
