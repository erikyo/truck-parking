...
export default class CannonDebugRenderer {
  ...
  private readonly _particleMaterial = new THREE.PointsMaterial()
  private readonly _sphereGeometry: THREE.SphereGeometry
  private readonly _boxGeometry: THREE.BoxGeometry
  private readonly _cylinderGeometry: THREE.CylinderGeometry
  private readonly _planeGeometry: THREE.PlaneGeometry
  private readonly _particleGeometry: THREE.BufferGeometry

  private readonly tmpVec0: CANNON.Vec3 = new CANNON.Vec3()
  private readonly tmpVec1: CANNON.Vec3 = new CANNON.Vec3()
  private readonly tmpVec2: CANNON.Vec3 = new CANNON.Vec3()
  private readonly tmpQuat0: CANNON.Quaternion = new CANNON.Quaternion()
